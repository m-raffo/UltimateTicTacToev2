...
int Node::GetPreviousMove() { return previousMove; }
...
void Node::DeleteChildren() { children.clear(); }

bool Node::HasChildren() { return childrenAdded; }
...
int Node::GetPreviousPlayer() { return previousPlayer; }
